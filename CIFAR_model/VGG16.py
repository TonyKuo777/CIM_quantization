...
class My_Model(nn.Module):
    def __init__(self, bitW, bitA, bitO, sub_channel='v', mode='ReRam', classes=10):
        ...
        self.feature = nn.Sequential(
            ...
            Conv2d_R2Q(in_channels=64, out_channels=128, kernel_size=3, stride=1, padding=1, bias=False, bitW=bitW, bitO=bitO, sub_channel=sub_channel, mode=mode),
            nn.BatchNorm2d(128),
            Act_Q(bitA=bitA),
