...
#from utils.Linear_Q import *
#-------------------------------------
#from utils.resnet_SRAM_LLSQ import *
from imagenet_models.resnet_SRAM import *
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    DIR =  './logs/resnet50_sram_testttt_' + 'w' + str(args.w) + 'a' + str(args.a) + '_sa' + str(args.sa) + '_sub_c' + args.sub_c
    ...
    '''
    if args.pretrained:
        model = resnet50_q(nbits_w=args.w, nbits_a=args.a, pretrained=True)
    else:
        model = resnet50_q(nbits_w=args.w, nbits_a=args.a, pretrained=False)
    '''
