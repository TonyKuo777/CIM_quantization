...
from imagenet_models.mobilenetv2_SRAM_LLSQ import *
'''
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    DIR =  './logs/mobilev2_sram_testtttt_' + 'w' + str(args.w) + 'a' + str(args.a) + '_sa' + str(args.sa) + '_sub_c' + args.sub_c
    ...
    '''
    if args.pretrained:
        model = mobilenetv2_q(pretrained=True, nbits_w=args.w, nbits_a=args.a)
    else:
        model = mobilenetv2_q(pretrained=False, nbits_w=args.w, nbits_a=args.a)
