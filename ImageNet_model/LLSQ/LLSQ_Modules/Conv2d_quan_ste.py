...
def w_nonideal(x):
    ...
    x[(temp_ni == 3) & (map < 0.007)] += 2
    x[(temp_ni == 3) & (map >= 0.007) & (map < 0.018)] += 1
    x[(temp_ni == 3) & (map >= 0.972)] -= 1
    
    x[(temp_ni == 4) & (map < 0.017)] += 1
    x[(temp_ni == 4) & (map >= 0.959) & (map < 0.98)] -= 1
    x[(temp_ni == 4) & (map >= 0.98)] -= 2

    x[(temp_ni == 5) & (map < 0.004)] += 2
    x[(temp_ni == 5) & (map >= 0.004) & (map < 0.02)] += 1
    x[(temp_ni == 5) & (map >= 0.983) & (map < 0.993)] -= 1
    x[(temp_ni == 5) & (map >= 0.993)] -= 2

    x[(temp_ni == 6) & (map < 0.01)] += 2
    x[(temp_ni == 6) & (map >= 0.01) & (map < 0.027)] += 1
    x[(temp_ni == 6) & (map >= 0.985) & (map < 0.998)] -= 1
    x[(temp_ni == 6) & (map >= 0.998)] -= 2
    ...
    x[(temp_ni == 8) & (map < 0.004)] += 2
    x[(temp_ni == 8) & (map >= 0.004) & (map < 0.058)] += 1
    x[(temp_ni == 8) & (map >= 0.979) & (map < 0.998)] -= 1
    x[(temp_ni == 8) & (map >= 0.998)] -= 2

    x[(temp_ni == 9) & (map < 0.007)] += 2
    x[(temp_ni == 9) & (map >= 0.007) & (map < 0.057)] += 1
    x[(temp_ni == 9) & (map >= 0.985) & (map < 0.996)] -= 1
    x[(temp_ni == 9) & (map >= 0.996)] -= 2
    ...
    x[(temp_ni == 18) & (map >= 0.001) & (map < 0.018)] += 2
    x[(temp_ni == 18) & (map >= 0.018) & (map < 0.151)] += 1
    x[(temp_ni == 18) & (map >= 0.949) & (map < 0.989)] -= 1
    x[(temp_ni == 18) & (map >= 0.989)] -= 2

    x[(temp_ni == 19) & (map < 0.004)] += 3
    x[(temp_ni == 19) & (map >= 0.004) & (map < 0.018)] += 2
    x[(temp_ni == 19) & (map >= 0.018) & (map < 0.147)] += 1
    x[(temp_ni == 19) & (map >= 0.898) & (map < 0.977)] -= 1
    x[(temp_ni == 19) & (map >= 0.977)] -= 2

    x[(temp_ni == 20) & (map < 0.004)] += 3
    x[(temp_ni == 20) & (map >= 0.004) & (map < 0.035)] += 2
    x[(temp_ni == 20) & (map >= 0.035) & (map < 0.147)] += 1
    x[(temp_ni == 20) & (map >= 0.877) & (map < 0.985)] -= 1
    x[(temp_ni == 20) & (map >= 0.985)] -= 2

    x[(temp_ni == 21) & (map < 0.004)] += 3
    x[(temp_ni == 21) & (map >= 0.004) & (map < 0.032)] += 2
    x[(temp_ni == 21) & (map >= 0.032) & (map < 0.152)] += 1
    x[(temp_ni == 21) & (map >= 0.862) & (map < 0.976)] -= 1
    x[(temp_ni == 21) & (map >= 0.976)] -= 2

    x[(temp_ni == 22) & (map < 0.006)] += 3
    x[(temp_ni == 22) & (map >= 0.006) & (map < 0.028)] += 2
    x[(temp_ni == 22) & (map >= 0.028) & (map < 0.163)] += 1
    x[(temp_ni == 22) & (map >= 0.872) & (map < 0.988)] -= 1
    x[(temp_ni == 22) & (map >= 0.988) & (map < 0.994)] -= 2
    x[(temp_ni == 22) & (map >= 0.994)] -= 3

    x[(temp_ni == 23) & (map < 0.01)] += 3
    x[(temp_ni == 23) & (map >= 0.01) & (map < 0.023)] += 2
    x[(temp_ni == 23) & (map >= 0.023) & (map < 0.106)] += 1
    x[(temp_ni == 23) & (map >= 0.896) & (map < 0.976)] -= 1
    x[(temp_ni == 23) & (map >= 0.976) & (map < 0.994)] -= 2
    x[(temp_ni == 23) & (map >= 0.994)] -= 3

    x[(temp_ni == 24) & (map < 0.012)] += 2
    x[(temp_ni == 24) & (map >= 0.012) & (map < 0.138)] += 1
    x[(temp_ni == 24) & (map >= 0.916) & (map < 0.977)] -= 1
    x[(temp_ni == 24) & (map >= 0.977) & (map < 0.996)] -= 2
    x[(temp_ni == 24) & (map >= 0.996)] -= 3

    x[(temp_ni == 25) & (map < 0.008)] += 2
    x[(temp_ni == 25) & (map >= 0.008) & (map < 0.15)] += 1
    x[(temp_ni == 25) & (map >= 0.916) & (map < 0.989)] -= 1
    x[(temp_ni == 25) & (map >= 0.989) & (map < 0.996)] -= 2
    x[(temp_ni == 25) & (map >= 0.996)] -= 3

    x[(temp_ni == 26) & (map < 0.017)] += 2
    x[(temp_ni == 26) & (map >= 0.017) & (map < 0.045)] += 1
    x[(temp_ni == 26) & (map >= 0.872) & (map < 0.975)] -= 1
    x[(temp_ni == 26) & (map >= 0.975)] -= 2

    x[(temp_ni == 27) & (map < 0.011)] += 2
    x[(temp_ni == 27) & (map >= 0.011) & (map < 0.031)] += 1
    x[(temp_ni == 27) & (map >= 0.939) & (map < 0.985)] -= 1
    x[(temp_ni == 27) & (map >= 0.985)] -= 2

    x[(temp_ni == 28) & (map < 0.017)] += 1
    x[(temp_ni == 28) & (map >= 0.967) & (map < 0.99)] -= 1
    x[(temp_ni == 28) & (map >= 0.99)] -= 2

    x[(temp_ni == 29) & (map < 0.002)] += 2
    x[(temp_ni == 29) & (map >= 0.002) & (map < 0.02)] += 1
    x[(temp_ni == 29) & (map >= 0.977) & (map < 0.992)] -= 1
    x[(temp_ni == 29) & (map >= 0.992)] -= 2

    x[(temp_ni == 30) & (map < 0.013)] += 1
    x[(temp_ni == 30) & (map >= 0.986) & (map < 0.994)] -= 1
    x[(temp_ni == 30) & (map >= 0.994)] -= 2

    x[(temp_ni == 31) & (map >= 0.992)] -= 1
    '''
    return x
...
def wo_nonideal(x):
    ...
    x[(temp_ni == 8) & (map < 0.051)] += 1
    x[(temp_ni == 8) & (map >= 0.998)] -= 1

    x[(temp_ni == 9) & (map < 0.057)] += 1
    x[(temp_ni == 9) & (map >= 0.998)] -= 1
    ...
    x[(temp_ni == 14) & (map < 0.009)] += 2
    x[(temp_ni == 14) & (map >= 0.009) & (map < 0.047)] += 1
    
    x[(temp_ni == 15) & (map < 0.019)] += 2
    x[(temp_ni == 15) & (map >= 0.019) & (map < 0.074)] += 1
    
    x[(temp_ni == 16) & (map < 0.007)] += 2
    x[(temp_ni == 16) & (map >= 0.007) & (map < 0.091)] += 1
    x[(temp_ni == 16) & (map >= 0.987)] -= 1
    
    x[(temp_ni == 17) & (map < 0.141)] += 1
    x[(temp_ni == 17) & (map >= 0.963)] -= 1
    
    x[(temp_ni == 18) & (map < 0.157)] += 1
    x[(temp_ni == 18) & (map >= 0.93) & (map < 0.991)] -= 1
    x[(temp_ni == 18) & (map >= 0.991)] -= 2
    
    x[(temp_ni == 19) & (map < 0.004)] += 2
    x[(temp_ni == 19) & (map >= 0.004) & (map < 0.161)] += 1
    x[(temp_ni == 19) & (map >= 0.925)] -= 1
    
    x[(temp_ni == 20) & (map < 0.021)] += 2
    x[(temp_ni == 20) & (map >= 0.021) & (map < 0.156)] += 1
    x[(temp_ni == 20) & (map >= 0.868) & (map < 0.959)] -= 1
    x[(temp_ni == 20) & (map >= 0.959)] -= 2

    x[(temp_ni == 21) & (map < 0.012)] += 2
    x[(temp_ni == 21) & (map >= 0.012) & (map < 0.151)] += 1
    x[(temp_ni == 21) & (map >= 0.887) & (map < 0.992)] -= 1
    x[(temp_ni == 21) & (map >= 0.992)] -= 2
    
    x[(temp_ni == 22) & (map < 0.151)] += 1
    x[(temp_ni == 22) & (map >= 0.89)] -= 1
    
    x[(temp_ni == 23) & (map < 0.013)] += 2
    x[(temp_ni == 23) & (map >= 0.013) & (map < 0.112)] += 1
    x[(temp_ni == 23) & (map >= 0.896) & (map < 0.982)] -= 1
    x[(temp_ni == 23) & (map >= 0.982)] -= 2

    x[(temp_ni == 24) & (map < 0.006)] += 2
    x[(temp_ni == 24) & (map >= 0.006) & (map < 0.145)] += 1
    x[(temp_ni == 24) & (map >= 0.943) & (map < 0.993)] -= 1
    x[(temp_ni == 24) & (map >= 0.993)] -= 2

    x[(temp_ni == 25) & (map < 0.001)] += 2
    x[(temp_ni == 25) & (map >= 0.001) & (map < 0.144)] += 1
    x[(temp_ni == 25) & (map >= 0.917)] -= 1
    
    x[(temp_ni == 26) & (map < 0.027)] += 1
    x[(temp_ni == 26) & (map >= 0.902)] -= 1
    
    x[(temp_ni == 27) & (map < 0.003)] += 1
    x[(temp_ni == 27) & (map >= 0.961)] -= 1
    
    x[(temp_ni == 28) & (map < 0.007)] += 1
    x[(temp_ni == 28) & (map >= 0.987)] -= 1
    
    x[(temp_ni == 29) & (map < 0.01)] += 1
    x[(temp_ni == 29) & (map >= 0.99)] -= 1
    
    x[(temp_ni == 30) & (map < 0.013)] += 1
    x[(temp_ni == 30) & (map >= 0.992)] -= 1
    
    x[(temp_ni == 31) & (map >= 0.997)] -= 1
    '''
    #x = x.masked_fill((temp_ni == 0) & (map >= 0.001) & (map < 0.9999), 100.)
    #print(x)
    #print(torch.sum(torch.abs(x-temp)))
    #print('=====')
    
    #print(torch.sum(torch.abs(x.data-temp_ni.data)))
    #print('***********************')
...
def input4_qsa(x, adc_list=None):
    '''
    x = torch.floor( x / 5 )
...
def input2_qsa(x, adc_list=None):
    '''
...
# %%
class sram_cim_conv_comb(torch.autograd.Function):
    @staticmethod
    def forward(ctx, input, weight, stride, padding, bias=None):
        ...
        for gp in range(GPS):
            ...
            for i in range(KH*KW):
                ...
                output_unfold += ( (CIM_MAC_comb(msb_x_int, w_int) << 4) + CIM_MAC_comb(lsb_x_int, w_int) )
...
class Conv2d_CIM_SRAM_comb(nn.Conv2d):
    def __init__(self,
                 in_channels,
                 out_channels,
                 kernel_size, 
                 ...
                 extern_init=False,
                 init_model=nn.Sequential(),):
        super(Conv2d_CIM_SRAM_comb, self).__init__(in_channels, out_channels, kernel_size, stride, padding,
                                              dilation, groups, bias)
        self.bit = bit
        self.pwr_coef =  2**(bit - 1) 
        self.Round_w = RoundFn_LLSQ.apply
        ...
        self.sram_cim_conv_comb = sram_cim_conv_comb.apply
    ...
    def forward(self, x):
        if self.bit == 32:
            ...
            #     assert not torch.isnan(wq).any(), "Conv2d Weights should not be 'nan'"
            #     assert not torch.isinf(wq).any(), "Conv2d Weights should not be 'nan'"
            outputs = self.sram_cim_conv_comb(x, w_q, self.stride, self.padding, LLSQ_b)
            return outputs

    def extra_repr(self):
        s_prefix = super(Conv2d_CIM_SRAM_comb, self).extra_repr()
        if self.alpha_w is None:
            return '{}, fake'.format(s_prefix)
        return '{}'.format(s_prefix)
